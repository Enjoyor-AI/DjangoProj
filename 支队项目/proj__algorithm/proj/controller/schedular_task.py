...
# from proj.python_project.scats_operate_parsing_wr.seperate_operate_record import main as operate_resolve
...
from ..python_project.detector_diagnosis.sched_task.detector_task import task_main
...
def create_scheduler():
    ...
    try:
        ...
        scheduler.add_job(task_main, "date", run_date=date, id='detector_task', args=[yesterday], replace_existing=True)
        # 开启数据清理程序
