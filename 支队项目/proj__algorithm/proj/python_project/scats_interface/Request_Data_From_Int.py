...
# 向接口请求动态数据
def RequestDynaDataFromInt(StartTime,EndTime):
    list_ManoperationRecord = []  # 4.7
    GetManoperationRecord = []
    payload1 = {r'STime': StartTime, r'ETime': EndTime}
    try:
        # print(payload1)
        get_response = requests.get(r'http://33.83.100.138:8081/getOperatorIntervention.html',
...
def MainLoop():
    ...
    error_inf = RequestDynaDataFromInt(StartTime,EndTime)  # 向接口请求动态数据并解析
