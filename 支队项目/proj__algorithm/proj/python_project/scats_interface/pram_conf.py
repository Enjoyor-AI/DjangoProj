...
# 发送解析失败通道信息
sql_send_parse_failed_detector = """
insert into pe_tobj_channel_error(sys_code,channel_id,node_id) values(%s,%s,%s)
"""
# 对缺失数据的时段进行检测
...
"""
sql_delete_channel_data = """
truncate table pe_tobj_channel_error
"""
...
url_interface_operate = "http://33.83.100.138:8081/getOperatorIntervention.html"
payload_operate = {'STime': None, 'ETime': None}

url_salklist = "http://33.83.100.138:8081/getStrategicmonitor.html"
