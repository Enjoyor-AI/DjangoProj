...
# Detector State
non_error_code, non_error_name, non_error_detail = 'NORMSTA', '数据正常', '数据准确'
major_error_code, major_error_name, major_error_detail = 'ERR0001', '数据缺失', '数据缺失'
major_error_overflow_code, major_error_overflow_name, major_error_overflow_detail = 'ERR0002', '数据异常', '流量异常'
major_error_oversaturated_code, major_error_oversaturated_name, major_error_oversaturated_detail = 'ERR0003', '数据异常', '饱和度异常'
major_error_overflowandsaturated_code, major_error_overflowandsaturated_name, major_error_overflowandsaturated_detail = 'ERR0004', '数据异常', '流量及饱和度异常'
major_error_noise_code, major_error_noise_name, major_error_noise_detail = 'ERR0005', '数据缺陷', '大量数据噪点'
...
major_error_communication_failed_code, major_error_communication_failed_name, major_error_communication_failed_detail = 'ERR0000', '数据缺陷', '短时通讯异常'
major_error_communication_error_code, major_error_communication_error_name, major_error_communication_error_detail = 'ERR1111', '数据缺失', '接口通讯中断'
minor_config_error_code, minor_config_error_name, minor_config_error_detail = 'WRN1111', '数据异常', '检测器绑定异常'
# Detector Rank
